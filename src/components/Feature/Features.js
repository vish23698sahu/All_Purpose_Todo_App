            ...
            <div className="feature-container" >
                ...
                <div className="container-new" >
                    <div className="items-1" >
                        ...
                        <img src={featureTwo} className="img-tran" width="350px" alt="feature" ></img>
                    </div>
                    <div className="items-2" >
                        ...
                        <img src={featureThree} className="img-tran" width="350px" alt="feature" ></img>
                    </div>
                    <div className="items-3" >
                        ...
                        <img src={featureFour} className="img-tran" width="350px" alt="feature"></img>
                    </div>
                </div>
            </div>
            <Footer />
